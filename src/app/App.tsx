...
export default function App() {
  ...
  const files_data = [
    { id: "1", filename: "hifigan_LA_D_1119156", spec: "hifigan.png", transcript:'it\'s very nice', regions:[ 
    ...
    { id: "3", filename: "hn-sinc-nsf_LA_T_3965355", spec: "hn-sinc-nsf.png",  transcript:'they come to enjoy themselves', regions:[
    ...
    { id: "2", filename: "hn-sinc-nsf-hifi_LA_T_3725354", spec: "hn-sinc-nsf-hifi.png", transcript:'she has fallen in love with scotland however', regions:[
    ...
    { id: "4", filename: "waveglow_LA_D_2407623", spec: "waveglow.png", transcript:'it\'s that kind of place', regions:[
